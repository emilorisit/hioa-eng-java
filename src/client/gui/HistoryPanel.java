...
/* This class creates the panel for the temperature-history to be shown */

public class HistoryPanel extends JPanel {


	private static final long serialVersionUID = 8926075093437451918L;
	...
	public HistoryPanel() {
		...
		historyDrawing = new HistoryDrawing(x1, x2, x3, x4, x5, x6,
				x7, x8, x9, x0, y1, y2, y3, y4, y5, y6, y7, y8, y9, y0);
